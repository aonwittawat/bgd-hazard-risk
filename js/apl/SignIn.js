 ...
 * Modified: Wittawat Bunnasarn - United Nation Satellite Centre - UNOSAT
 *
 */
    ...
    return new Promise((resolve, reject) => {
      if (this.portal) {
        ...
        if (hasUser) {
          ...
          this.userStatusBtn.innerHTML = this.portal.user.username === "unosat_viewer" ? "DDM Viewer" : this.portal.user.fullName;
          ...
          const organizationUrl = this.portal.url;
